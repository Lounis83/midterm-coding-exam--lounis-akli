...
public class UseMap {
	...
	public static void main(String[] args) throws Exception {
		...
		worldCup.put(1990, "Germany");
		worldCup.put(1994, "Brazil");
		...
		connect.insertDataFromArrayListToSqlTable((ArrayList<String>) teamEngland, "England", "Team");
		connect.insertDataFromArrayListToSqlTable((ArrayList<String>) teamSpain, "Spain", "Team");
		connect.insertDataFromArrayListToSqlTable((ArrayList<String>) teamItaly, "Italy", "Team");
